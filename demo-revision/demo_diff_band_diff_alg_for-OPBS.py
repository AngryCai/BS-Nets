...
path = 'F:\Python\DeepLearning\AttentionBandSelection\\results\OPBS-indian-paviaU-salinas-top50band-index.npz'
npz = np.load(path)
...
"""
======================
add OPBS res. into all alg.
======================
"""

import matplotlib.pyplot as plt
import numpy as np
p_conv = 'F:\Python\DeepLearning\AttentionBandSelection\\results\diff_band_diff_alg-acc-Salinas-[3-30]-added-FC-MOBS.npz'
...
score_conv['OPBS'] = acc_dict['OPBS']
np.savez('F:\Python\DeepLearning\AttentionBandSelection\\results\diff_band_diff_alg-acc-'+ im_ + '-[3-30]-added-All.npz',
